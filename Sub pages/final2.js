...
function draw() {
    image(backgroundImg, x1, 0, width, height); //draws two background imgs that change to make background move link: https://stackoverflow.com/questions/46411729/running-background-in-p5
